		 ...
		 const lyrics =  {
			 ...
			 getLyrics: async () => {
				 ...
				 try {
					 ...
					 //BDFDB.NotificationUtils.toast("FETCHED")
					 
					 //BDFDB.NotificationUtils.toast("song id : "+ lastSongName);
					 ...
					 try {
						 if(typeof(currentLyrics.length) == 'number'){
							 BDFDB.NotificationUtils.toast('the song exist in the data base, but no lyrics for the moment')
							 Status.unset()
						 } else {
